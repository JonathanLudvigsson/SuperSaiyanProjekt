...
namespace SuperSaiyanProjekt.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Project proj1 = new Project { ProjectId = 1, ProjectName = "Project A", ProjectDescription = "Description of Project A", StartDate = new DateTime(2022, 1, 1), EndDate = new DateTime(2022, 12, 31) };
            Project proj2 = new Project { ProjectId = 2, ProjectName = "Project B", ProjectDescription = "Description of Project B", StartDate = new DateTime(2023, 1, 1), EndDate = new DateTime(2023, 12, 31) };
